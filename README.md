...
- Extract the zip file EasyRSA  Go to cmd Go to folder where extracted files are located  type .\EasyRSA-Start.bat ./easyrsa init-pki  enter SERVER  ./easyrsa build-ca nopass ./easyrsa build-server-full server nopass  enter Yes  ./easyrsa build-client-full client1.domain.tld nopass  Exit
